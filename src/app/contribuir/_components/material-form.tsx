...
import criarMaterial from "@/http/criar-material";
...
const formSchema = z
    .object({
        ...
        quantidade: z.number().min(1, { message: "Deve ter pelo menos um material" }).optional(),
        arquivo: z.instanceof(File).refine((file) => file.size > 0, "O arquivo não pode estar vazio"),
    })
...
const MaterialForm = () => {
    ...
    async function onSubmit(data: z.infer<typeof formSchema>) {
        ...
        try {
            await criarMaterial(data, setProgress);
